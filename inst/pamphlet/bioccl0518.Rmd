...
work with remote cloud-scale resources.  **All demonstrations are based on the "devel branch" of Bioconductor in R 3.5.**

# HDF server for SummarizedExperiment assays

We have created an [HDF5 server](https://support.hdfgroup.org/projects/hdfserver/) at `h5s.channingremotedata.org:5000` whose use
is described in the `rhdf5client` [package vignette](http://bioconductor.org/packages/devel/bioc/vignettes/rhdf5client/inst/doc/h5client.html) (devel branch
until October 2018).
